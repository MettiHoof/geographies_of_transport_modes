...
# Written by Maarten Vanhoof, DECEMBER 2019, updated in MARCH 2020.
# Python 3
#
...
home_to_work=True
work_to_home=False ## YOU CANNOT CHOOSE THIS OPTION SINCE FILTERING IN SECTION 4.2.1 IS NOT YET IMPLEMENTED FOR THE WORK TO HOME DIRECTION
...
# Our aim is to aggregate the information on distances and observed trips per MSOA so 
