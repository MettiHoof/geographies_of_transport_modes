...
#
# direction = work_to_home or home_to_work; is the direction of the aggregation. 
#
# hardcoded percentage filer = MSOA to MSOA connections that made up less than
...
if newfiles:
	...
	#Old files
	inputfile_signatures = foldername_input + 'Signatures/df_output_001_old_files.csv'
...
df_signatures[[	'avg_car_shortest_route_home_to_work_0.01',
				'avg_bus_shortest_route_home_to_work_0.01',
				'avg_rail_shortest_route_home_to_work_0.01']].describe()
